            ...
            message.append("\n").append(AdaptMessage.getAdaptMessage().adaptTeamMessage(
                    LangManager.getMessage(
                            ...
                            .replaceAll("\\[TEAM_EDIT_relation]",
                                    TeamManager.getManager().getTeamRelation(invite.getSenderTeam(), invite.getTargetTeam())
                                            .getType().getDisplay().replaceAll("\\[TEAM_EDIT_relation_invite]", invite.getRelationType().name()))
