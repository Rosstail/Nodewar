...
public enum LangMessage {
    ...
    COMMANDS_ADMIN_TEAM_COLOR_DESC("commands.admin.team.color.desc", false, false),
    COMMANDS_ADMIN_TEAM_COLOR_RESULT("commands.admin.team.color.result", false, false),
    COMMANDS_ADMIN_TEAM_OPEN_DESC("commands.admin.team.open.desc", false, false),
    COMMANDS_ADMIN_TEAM_OPEN_RESULT("commands.admin.team.open.result", false, false),
    COMMANDS_ADMIN_TEAM_CLOSE_DESC("commands.admin.team.close.desc", false, false),
    COMMANDS_ADMIN_TEAM_CLOSE_RESULT("commands.admin.team.close.result", false, false),
    ...
    COMMANDS_ADMIN_TEAM_MEMBER_DEMOTE_RESULT("commands.admin.team.member.demote.result", false, false),
    COMMANDS_ADMIN_TEAM_MEMBER_TRANSFER_DESC("commands.admin.team.member.transfer.desc", false, false),
    COMMANDS_ADMIN_TEAM_MEMBER_TRANSFER_RESULT("commands.admin.team.member.transfer.result", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_DESC("commands.admin.team.relation.desc", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_OPEN_DESC("commands.admin.team.relation.open.desc", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_OPEN_RESULT("commands.admin.team.relation.open.result", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_CLOSE_DESC("commands.admin.team.relation.close.desc", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_CLOSE_RESULT("commands.admin.team.relation.close.result", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_INVITES_DESC("commands.admin.team.relation.edit.desc", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_INVITES_RESULT_HEADER("commands.admin.team.relation.invites.result-header", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_INVITES_RESULT_LINE("commands.admin.team.relation.invites.result-line", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_INVITES_RESULT_LINE_RECEIVED("commands.admin.team.relation.invites.result-line-received", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_INVITES_RESULT_LINE_SENT("commands.admin.team.relation.invites.result-line-sent", false, false),
    COMMANDS_ADMIN_TEAM_RELATION_EDIT_DESC("commands.admin.team.relation.edit.desc", false, false),
