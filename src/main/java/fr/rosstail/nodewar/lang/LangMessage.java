...
public enum LangMessage {
    ...
    COMMANDS_TEAM_MANAGE_RELATION_EDIT_RESULT_SENT("commands.team.manage.relation.edit.result-sent", false, false),
    COMMANDS_TEAM_MANAGE_RELATION_EDIT_RESULT_EFFECTIVE("commands.team.manage.relation.edit.result-effective", false, false),
    COMMANDS_TEAM_MANAGE_RELATION_EDIT_RESULT_BLOCKED("commands.team.manage.relation.edit.result-blocked", false, false),
    COMMANDS_TEAM_MANAGE_RELATION_EDIT_RESULT_UNCHANGED("commands.team.manage.relation.edit.result-unchanged", false, false),
    COMMANDS_TEAM_MANAGE_RELATION_EDIT_RESULT_ALREADY_SENT("commands.team.manage.relation.edit.result-already-sent", false, false),
    ...
    COMMANDS_ADMIN_TEAM_EDIT_RELATION_EDIT_RESULT_ALREADY("commands.admin.team.edit.relation.edit.result-already", false, false),
